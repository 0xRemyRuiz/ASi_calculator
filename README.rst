...
The idea was to redo a fun project from my past studies to set me back on track regarding programming and to level up my python skills. It has no other purpose than to make me learn and have fun at the same time.
...
As per the main functionnality, it's simple maths. Here is an example of possible calculation with different compatible symbols used :
...
You may need to use another alias instead of `py` for calling python, such as `python` or `python3`, it depends on your environnement.
I did not make this a module nor did I added a shebang for linux, a matter of taste and compatibility.
...
-------
 ...
 #. [ ] implement an RPN version of the parser
